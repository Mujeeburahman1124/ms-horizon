...
$adminNav = [
    ['section' => 'Main'],
    ['title' => 'Dashboard',        'icon' => 'fa-chart-line',      'url' => '/admin/dashboard',        'badge' => null],
    ['section' => 'Divisions'],
    ['title' => 'Visa Applications','icon' => 'fa-passport',         'url' => '/admin/visas',            'badge' => null],
    ['title' => 'Reservations',     'icon' => 'fa-plane-departure',  'url' => '/admin/reservations',     'badge' => null],
    ['title' => 'Candidates',       'icon' => 'fa-user-tie',         'url' => '/admin/candidates',       'badge' => null],
    ['title' => 'Jobs',             'icon' => 'fa-briefcase',        'url' => '/admin/jobs',             'badge' => null],
    ['title' => 'Business Leads',   'icon' => 'fa-building-columns', 'url' => '/admin/business-leads',  'badge' => null],
    ['title' => 'Software Projects','icon' => 'fa-laptop-code',      'url' => '/admin/software-projects','badge' => null],
    ['section' => 'Content'],
    ['title' => 'Offers & Promos',  'icon' => 'fa-tags',             'url' => '/admin/offers',           'badge' => null],
    ['title' => 'Blog Posts',       'icon' => 'fa-newspaper',        'url' => '/admin/blog',             'badge' => null],
    ['title' => 'Enquiries',        'icon' => 'fa-envelope',         'url' => '/admin/enquiries',        'badge' => null],
    ['section' => 'System'],
    ['title' => 'Users & Staff',    'icon' => 'fa-users',            'url' => '/admin/users',            'badge' => null],
    ['title' => 'Audit Logs',       'icon' => 'fa-shield-halved',    'url' => '/admin/audit-logs',       'badge' => null],
    ['title' => 'View Website',     'icon' => 'fa-external-link-alt','url' => '/',                       'badge' => null],
    ['title' => 'Sign Out',         'icon' => 'fa-right-from-bracket','url' => '/logout',                'badge' => null],
];
